...
<head>
    ...
    <title>Gerenciar Cardápio - Brasa & Tradição</title>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between border-b border-stone-700/60 pb-6 mb-6 gap-4">
            <div>
                ...
                <h1 class="font-serif-elegant text-3xl font-bold text-stone-100 tracking-wide">
                    🥩 Gerenciamento de <span class="text-amber-500">Cardápio</span>
                </h1>
            </div>
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="createcard.php" class="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-500 hover:to-orange-500 text-stone-900 font-bold px-5 py-2.5 rounded-xl text-sm uppercase tracking-wider shadow-lg shadow-orange-950/40 transition duration-200">
                    + Adicionar Item
                </a>
            </div>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-stone-900 text-stone-400 border-b border-stone-700/60 text-xs font-semibold uppercase tracking-wider">
                        ...
                        <th class="py-4 px-6">Nome do Prato / Corte</th>
                        <th class="py-4 px-6">Preço</th>
                        <th class="py-4 px-6 text-center">Disponibilidade</th>
                ...
                <tbody class="divide-y divide-stone-800 text-sm">
                    ...
                    <?php else: ?>
                        ...
                        <tr class="hover:bg-stone-800/30 transition duration-150">
                            ...
                            <td class="py-4 px-6 text-amber-500 font-semibold">
